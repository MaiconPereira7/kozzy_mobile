...
import { FlatList, Modal, Platform, RefreshControl, StatusBar, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
                        ...
                        {selected && (() => {
                            ...
                            return (
                                <>
                                    ...
                                    <DetailRow icon="pricetag-outline" label="Categoria" value={selected.category} colors={colors} styles={styles} />
                                    <DetailRow icon="calendar-outline" label="Data" value={`${selected.date} às ${selected.time}`} colors={colors} styles={styles} />
...
const DetailRow = ({ icon, label, value, colors, styles }: { icon: any; label: string; value: string; colors: Colors; styles: any }) => (
    <View style={styles.detailRow}>
        <View style={styles.detailLeft}>
...
const makeStyles = (c: Colors) => StyleSheet.create({
    ...
    modal: { backgroundColor: c.white, borderTopLeftRadius: BORDER_RADIUS.round, borderTopRightRadius: BORDER_RADIUS.round, padding: SPACING.xl, maxHeight: '85%' },
    ...
    descBox: { backgroundColor: c.backgroundLight, borderRadius: BORDER_RADIUS.lg, padding: SPACING.md, marginBottom: SPACING.lg },
    descText: { fontSize: TYPOGRAPHY.sizes.md, color: c.text.primary, lineHeight: 20 },
    closeBtn: { backgroundColor: c.backgroundLight, borderRadius: BORDER_RADIUS.xl, height: 48, justifyContent: 'center', alignItems: 'center' },
