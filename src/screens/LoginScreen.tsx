  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const msg = error?.code === 401
        ...
        : error.message || 'Erro ao fazer login. Verifique a conexão.';
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.registerBtn} onPress={() => navigation.navigate('Register')}>
            <Text style={styles.registerText}>Não tem conta? <Text style={styles.registerLink}>Criar conta</Text></Text>
          </TouchableOpacity>
        </View>
...
const makeStyles = (c: Colors) => StyleSheet.create({
  ...
  registerBtn: { marginTop: SPACING.lg, alignItems: 'center' },
  registerText: { fontSize: TYPOGRAPHY.sizes.sm, color: c.text.secondary },
  registerLink: { color: c.primary, fontWeight: TYPOGRAPHY.weights.bold },
